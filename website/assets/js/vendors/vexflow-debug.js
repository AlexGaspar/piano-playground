	...
	var Renderer = exports.Renderer = function () {
	  _createClass(Renderer, null, [{
	    ...
	    value: function bolsterCanvasContext(ctx) {
	      ...
	      var methodNames = ['resetSVG', 'setFont', 'setRawFont', 'setFillStyle', 'setBackgroundFillStyle', 'setStrokeStyle', 'setShadowColor', 'setShadowBlur', 'setLineWidth', 'setLineCap', 'setLineDash', 'openGroup', 'closeGroup', 'getGroup'];
